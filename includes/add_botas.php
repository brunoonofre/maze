<?php
    ...
    $submit = $mysqli->query("INSERT INTO botas (id_utilizador, nome, n_colaborador, centro_custos, departamento, tamanho, tipo, estado, data, admissao) VALUES ('$id_utilizador','$nome','$n_colaborador','$ccustos','$departamento','$tamanho','$tipo','$estado','$data','$admissao')"); 
